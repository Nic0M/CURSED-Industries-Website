...
f.setAttribute("class","table table-striped");var g=f.createTHead().insertRow();g.insertCell().innerHTML="Unique ID";g.insertCell().innerHTML="Duration";g.insertCell().innerHTML="Start Time";g.insertCell().innerHTML="End Time";g.insertCell().innerHTML="Max Height AGL";g.insertCell().innerHTML="Max Speed";var l=f.createTBody();k.flights.forEach(m=>{const n=l.insertRow();let p=n.insertCell();document.createElement("a").setAttribute("href","https://google.com/search?q="+m.src_addr);unique_id_inner_html.innerText=
m.unique_id;p.innerHTML=unique_id_inner_html;n.insertCell().innerHTML=module$contents$database_tables_format_duration(m.duration);n.insertCell().innerHTML=m.start_time;n.insertCell().innerHTML=m.end_time;n.insertCell().innerHTML=module$contents$database_tables_format_altitude(m.max_height_agl);n.insertCell().innerHTML=module$contents$database_tables_format_speed(m.max_gnd_speed)});a.appendChild(f)}}catch(h){console.log("Error:",h)}}let module$contents$database_tables_current_offset=0;
