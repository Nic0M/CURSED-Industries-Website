...
a&&g.error&&console.error(g.error)}drone_stats={unique_id,speed:current_speed,heading:current_heading};console.log("Lat Lon List:",b);console.log("Drone stats:",drone_stats);drone_maps.create_trajectory(module$contents$live_map_live_map,b,orange_color,module$contents$live_map_orange_icon,drone_stats)}catch(c){console.error(c)}}module$contents$live_map_rest_api_trajectory();
