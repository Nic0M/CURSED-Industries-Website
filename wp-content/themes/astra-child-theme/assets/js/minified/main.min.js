...
new module$contents$drone_maps_DroneIconClass({iconUrl:"https://cursedindustries.com/images/drone_marker_icon_pink.png"});L.marker([40.03,-105.1],{icon:module$contents$drone_maps_red_icon}).addTo(module$contents$drone_maps_live_map).bindPopup("I'm a red drone!");L.marker([40.04,-105.1],{icon:module$contents$drone_maps_orange_icon}).addTo(module$contents$drone_maps_live_map).bindPopup("I'm an orange drone!");L.marker([40.05,-105.1],{icon:module$contents$drone_maps_yellow_icon}).addTo(module$contents$drone_maps_live_map).bindPopup("I'm a yellow drone!");
L.marker([40.06,-105.1],{icon:module$contents$drone_maps_green_icon}).addTo(module$contents$drone_maps_live_map).bindPopup("I'm a green drone!");L.marker([40.07,-105.1],{icon:module$contents$drone_maps_cyan_icon}).addTo(module$contents$drone_maps_live_map).bindPopup("I'm a cyan drone!");L.marker([40.08,-105.1],{icon:module$contents$drone_maps_lilac_icon}).addTo(module$contents$drone_maps_live_map).bindPopup("I'm a lilac drone!");L.marker([40.09,-105.1],{icon:module$contents$drone_maps_pink_icon}).addTo(module$contents$drone_maps_live_map).bindPopup("I'm a pink drone!");
