...
var module$contents$drone_maps_DroneIconClass=L.Icon.extend({options:{iconSize:[100,100],iconAnchor:[50,50],popupAnchor:[0,-50]}}),module$contents$drone_maps_red_icon=new module$contents$drone_maps_DroneIconClass({iconUrl:"https://cursedindustries.com/images/drone_marker_icon_red.png"}),module$contents$drone_maps_orange_icon=new module$contents$drone_maps_DroneIconClass({iconUrl:"https://cursedindustries.com/images/drone_marker_icon_orange.png"}),module$contents$drone_maps_yellow_icon=new module$contents$drone_maps_DroneIconClass({iconUrl:"https://cursedindustries.com/images/drone_marker_icon_yellow.png"}),
module$contents$drone_maps_green_icon=new module$contents$drone_maps_DroneIconClass({iconUrl:"https://cursedindustries.com/images/drone_marker_icon_green.png"}),module$contents$drone_maps_cyan_icon=new module$contents$drone_maps_DroneIconClass({iconUrl:"https://cursedindustries.com/images/drone_marker_icon_cyan.png"}),module$contents$drone_maps_lilac_icon=new module$contents$drone_maps_DroneIconClass({iconUrl:"https://cursedindustries.com/images/drone_marker_icon_lilac.png"}),module$contents$drone_maps_pink_icon=
new module$contents$drone_maps_DroneIconClass({iconUrl:"https://cursedindustries.com/images/drone_marker_icon_pink.png"});red_marker=L.marker([40.03,-105.1],{icon:module$contents$drone_maps_red_icon}).addTo(module$contents$drone_maps_live_map).bindPopup("I'm a red drone!");orange_marker=L.marker([40.04,-105.1],{icon:module$contents$drone_maps_orange_icon}).addTo(module$contents$drone_maps_live_map).bindPopup("I'm an orange drone!");yellow_marker=L.marker([40.05,-105.1],{icon:module$contents$drone_maps_yellow_icon}).addTo(module$contents$drone_maps_live_map).bindPopup("I'm a yellow drone!");
green_marker=L.marker([40.06,-105.1],{icon:module$contents$drone_maps_green_icon}).addTo(module$contents$drone_maps_live_map).bindPopup("I'm a green drone!");cyan_marker=L.marker([40.07,-105.1],{icon:module$contents$drone_maps_cyan_icon}).addTo(module$contents$drone_maps_live_map).bindPopup("I'm a blue drone!");lilac_marker=L.marker([40.08,-105.1],{icon:module$contents$drone_maps_lilac_icon}).addTo(module$contents$drone_maps_live_map).bindPopup("I'm a purple drone!");
purple_marker=L.marker([40.09,-105.1],{icon:module$contents$drone_maps_pink_icon}).addTo(module$contents$drone_maps_live_map).bindPopup("I'm a pink drone!");red_marker.setRotationAngle(45);orange_marker.setRotationAngle(90);yellow_marker.setRotationAngle(135);green_marker.setRotationAngle(180);cyan_marker.setRotationAngle(225);lilac_marker.setRotationAngle(270);purple_marker.setRotationAngle(315);
var module$contents$drone_maps_red_drone_path_lat_lon=[[40.022,-103.2],[40.023,-103.3],[40.027,-103.4],[40.031,-103.5],[40.035,-103.87],[40.03,-105.1]],module$contents$drone_maps_red_polyline=L.polyline(module$contents$drone_maps_red_drone_path_lat_lon,{color:"#ff3131"}).addTo(module$contents$drone_maps_live_map);
