...
setInterval(module$contents$database_tables_getRaspberryPiStatus,3E5);var module$exports$drone_maps={},module$contents$drone_maps_live_map=L.map("live-map",{center:[40.02,-105.2],zoom:13});L.tileLayer("https://tile.openstreetmap.org/{z}/{x}/{y}.png",{minZoom:1,maxZoom:19,attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'}).addTo(module$contents$drone_maps_live_map);
