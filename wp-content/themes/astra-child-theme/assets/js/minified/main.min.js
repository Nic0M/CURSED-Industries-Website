...
green_marker=L.marker([40.06,-105.1],{icon:module$contents$drone_maps_green_icon}).addTo(module$contents$drone_maps_live_map).bindPopup("I'm a green drone!");cyan_marker=L.marker([40.07,-105.1],{icon:module$contents$drone_maps_cyan_icon}).addTo(module$contents$drone_maps_live_map).bindPopup("I'm a cyan drone!");lilac_marker=L.marker([40.08,-105.1],{icon:module$contents$drone_maps_lilac_icon}).addTo(module$contents$drone_maps_live_map).bindPopup("I'm a lilac drone!");
