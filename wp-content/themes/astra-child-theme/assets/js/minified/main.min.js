...
let active_flights_refresh_time_text_interval_id=0,historical_flights_refresh_time_text_interval_id=0,remoteid_packets_refresh_time_text_interval_id=0,raspberry_pi_status_refresh_time_text_interval_id=0,refresh_text_interval_time=450;console.log("Creating active flights table");getActiveFlights();console.log("Creating historical flights table");getHistoricalFlights();console.log("Create Remote ID packets table");getRemoteIDPackets();console.log("Create Raspberry Pi status table");getRaspberryPiStatus();
