...
f.data[f.data.length-1];d=last_data.timestamp;c.set("Latest-Timestamp",d);current_heading=last_data.heading??"Unknown";current_speed=last_data.gnd_speed??"Unknown";unique_id=last_data.unique_id??"Unknown";for(let g=0;g<f.data.length;g++)lat_lon_list.push([f.data[g].lat,f.data[g].lon]);break;case 400:console.log("Bad Request:",b);break;case 404:console.log("End of data")}if(data.error){console.error(data.error);return}}drone_stats={unique_id,speed:current_speed,heading:current_heading};console.log("Lat Lon List:",
lat_lon_list);console.log("Drone stats:",drone_stats);create_trajectory(module$contents$live_map_live_map,lat_lon_list,orange_color,module$contents$live_map_orange_icon,drone_stats)}catch(c){console.error(c)}}module$contents$live_map_rest_api_trajectory();
